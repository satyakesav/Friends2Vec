...
class NeuMF_Social(torch.nn.Module):
    def __init__(self, config):
        ...
        self.social_mlp = torch.nn.Linear(user_social_dim_in, user_social_dim_out)
...
#         self.logistic = torch.nn.Sigmoid()
    ...
    def forward(self, user_indices, item_indices, social_embeddings):
        ...
        mlp_vector = torch.cat([user_embedding_mlp, item_embedding_mlp, soical_vector], dim=-1)  # the concat latent vector
